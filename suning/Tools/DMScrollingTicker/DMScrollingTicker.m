...
#pragma mark mark - LPScrollingTicker
...
#pragma mark mark - LPScrollingTickerLabelItem
...
- (id) initWithTitle:(NSAttributedString *) title description:(NSAttributedString *) description {
...
- (void) layoutSubviews {
   ...
   // descriptionLabel.frame = CGRectMake(titleLabel.frame.origin.x+titleLabel.frame.size.width+kLPScrollingTickerLabelItem_Space, 0, bestSize_subtitle.width, self.frame.size.height);
    [self setFrame:CGRectMake(self.frame.origin.x,
                              self.frame.origin.y,
                              bestSize_title.width+kLPScrollingTickerLabelItem_Space, 
