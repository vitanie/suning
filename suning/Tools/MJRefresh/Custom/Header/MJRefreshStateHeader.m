...
- (void)placeSubviews
{
    ...
    if (self.lastUpdatedTimeLabel.hidden) {
        // 状态
        self.stateLabel.mj_x = 10;
        self.stateLabel.mj_y = self.mj_h * 0.5/2;
        self.stateLabel.mj_w = kWindowWidth;
        self.stateLabel.mj_h = self.mj_h * 0.5;
    } else {
        // 状态
        self.stateLabel.mj_x = kWindowWidth * 0.5 - 20;
        self.stateLabel.mj_y = self.mj_h * 0.5/2;
        self.stateLabel.mj_w = kWindowWidth;
        self.stateLabel.mj_h = self.mj_h * 0.5;
        
        // 更新时间
        self.lastUpdatedTimeLabel.mj_x = kWindowWidth * 0.5 - 20;
        self.lastUpdatedTimeLabel.mj_y = self.stateLabel.mj_h;
        self.lastUpdatedTimeLabel.mj_w = kWindowWidth;
